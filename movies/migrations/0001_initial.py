    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.PositiveSmallIntegerField(default=0, help_text='указывает сумму в долларах', verbose_name='Бюджет')),
                ('fees_in_usa', models.PositiveSmallIntegerField(default=0, help_text='указывает сумму в долларах', verbose_name='Сборы В США')),
                ('fees_in_world', models.PositiveSmallIntegerField(default=0, help_text='указывает сумму в долларах', verbose_name='Сборы в мире')),
